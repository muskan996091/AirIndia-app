...
public class drawer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("AirIndiaa");
    ...
    private void getData() {
        List<String> title= Arrays.asList("Air India", "AIESL","AirIndia Express");
        List<String> childitem=Arrays.asList("Airline", "MRO", "Ground staff");
